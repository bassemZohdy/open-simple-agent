...
- Vitest/Testing Library coverage for API auth/error behavior and agent rendering.

Templates, resources, deployments, audit, agent editing/versioning, and invocation console remain P3.1 follow-up work.
