...
| CI | Format, lint, strict mypy, 442 collected tests (421 local plus 21 PostgreSQL tests in CI), container build + smoke test | No coverage gate, security scan, or release automation |
