...
> remaining distributed A2A streaming/late-event contract, deployment-specific
...
distributed A2A streaming/late-event acceptance, deployment-specific browser
