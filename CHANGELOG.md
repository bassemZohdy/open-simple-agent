...
### Fixed — MCP metadata origin
- Corrected resource and prompt metadata to retain the configured MCP server
  name in `mcp_name`, matching tool metadata and origin semantics.
